 ...
 *
 * Referred : https://github.com/googlesamples/android-Camera2Basic/tree/master/kotlinApp
 */
...
class Camera2BasicFragment : Fragment(),
    ...
    private lateinit var afAvailableModes:IntArray
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        EventBus.getDefault().register(this@Camera2BasicFragment)
    }

    override fun onDestroy() {
        super.onDestroy()
        EventBus.getDefault().unregister(this@Camera2BasicFragment)
    }
    ...
    private fun captureStillPicture() {
        try {
            ...
            file = File(activity!!.getExternalFilesDir(null), "${System.currentTimeMillis()}_$PIC_FILE_NAME")
            val rotation = activity!!.windowManager.defaultDisplay.rotation
    ...
    fun buttonCaptureClicked(event: Events.ButtonCaptureClicked) {
        captureStillPicture()
    }
